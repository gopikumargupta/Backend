...
import { subscriber } from '../models/subscription.module.js'
...
const getUserChannelProfie=asyncHandler(async(req,res)=>{
  ...
  return res.status(200).
  json(new ApiResponse(200,channel[0],"User Channel Feached succesfully"))
...
const getWatchHistory=asyncHandler(async(req,res)=>{
  ...
  res.status(200).
  json(new ApiResponse(200,user[0].watchHistory,"Watch history feached succesfully"))

})

export {registerUser,loginUser,logoutUser,refreshaccestoken,changeCurrentPassword,CurentUser,updateUserAvtar,updateUsercover,updateAccountDetails,getWatchHistory,getUserChannelProfie}